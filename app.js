...
(function($) {
    ...
    $(".color-switch").on("click", "button", function() {
      $(this)
        ...
        .siblings()
        .removeClass("active");
      $("#layoutstyle").attr("href", "http://bestwebcreator.com/cryptocash/demo/assets/color/" + $(this).val() + ".css");
    });
    ...
    function init() {
      ...
      var marker = new google.maps.Marker({
        ...
        map: map,
        icon: "http://bestwebcreator.com/cryptocash/demo/assets/images/marker.png",
        title: "Snazzy!"
      });
    }
  })(jQuery);
